...
dpg.create_context()
dpg.create_viewport(title="Melody",large_icon="icon.ico",small_icon="icon.ico")
pygame.mixer.init()
...
with dpg.window(tag="main",label="window title"):
	...
	with dpg.group(horizontal=True):
		with dpg.child_window(width=200,tag="sidebar"):
			dpg.add_text("Melody-Music streaming",color=(137, 142, 255))
			dpg.add_text("Music streaming",color=(137, 142, 255))
			dpg.add_spacer(height=2)
			dpg.add_separator()
